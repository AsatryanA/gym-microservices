...
public class LoggingAspect {
    ...
    @Pointcut("within(com.epam.reportservice.repository..*)" +
            " || within(com.epam.reportservice.service..*)")
    public void applicationPackagePointcut() {
    }

    @Pointcut("execution(* com.epam.reportservice.*.getById(Long))")
    public void findByIdMethods() {
    }

    @Pointcut("execution(* com.epam.reportservice.*.create(..))")
